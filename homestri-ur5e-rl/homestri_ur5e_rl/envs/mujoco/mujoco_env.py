...
class MujocoEnv(BaseMujocoEnv):
    ...
    #     self.render_context = mujoco.MjRenderContextOffscreen(self.model)
    ...
    #         self.scene
    #     )
    #     mujoco.mjr_render(self.render_context, self.scene, self.context)
    #     img = self.render_context.read_pixels(width, height, depth=False)
